...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{route('admin.role.add')}}">  <button class="btn btn-primary float-right"> Add New</button></a>
                </div>
            </div>
            <br>
                ...
                <td width="50px">
                    <div class="dropdown dropdown-menu-bottom">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="{{route('admin.role.getOne',$role->id)}}">Edit/View</a></li>
                        </ul>
                    </div>
                </td>
            </tr>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                           ...
                           <a href="{{route('admin.role.deleteOne',$role->id)}}"> <button type="button" class="btn btn-primary">Yes</button></a>
                        </div>
                    </div>
                </div>
            </div>
